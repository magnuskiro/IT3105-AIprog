...
def addContext(player, action):
    context = str(game.state) + str(game.getLenRemaining()) + str(pot_odds(game.table, player))
    #print context
    #print action
    context = context + action
    #print game.contextList[player.no]
    #print player.no
    if context in game.contextList[player.no-1]:
        player.hs = game.contextList[player.no-1][context]
