...
When the .wav files are read in Matlab they are represented in a one dimensional array with doubles. e.g: [-0.0131; -0.0073; 0.0010; 0.0125]
    \subsection{Data Structure} % needs to be updated, with the new data structure. 
...
% fill inn what the hmm does and how it works. 

prior model
% describe the priModel and its properties and usage.

dynamic model 
% describe the dynModel and its properties and usage. 
...
%write about how our observation model looks like. and how it is used. 
